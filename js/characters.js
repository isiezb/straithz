...
const CHARACTERS = [
    ...
    },
    {
        ...
        uniqueEvents: [
            ...
            {
                id: 'K05_senate_subpoena', title: '', image: 'assets/event-kushner-exposure.png',
                description: '',
                minDay: 35, maxDay: 55,
                condition: () => SIM.uniqueResource > 50,
                choices: [
                    { text: '', effects: { domesticApproval: -5, exposure: 10, credibility: 5 },
                      flavor: '',
                      setFlags: { senate_subpoena_testified: true } },
                    { text: '', effects: { domesticApproval: -3, exposure: 5 },
                      flavor: '',
                      setFlags: { senate_subpoena_challenged: true } },
                    { text: '', effects: { domesticApproval: 5, exposure: 15, diplomaticCapital: 5 },
                      flavor: '',
                      setFlags: { senate_subpoena_leaked: true } },
                ],
            },
            {
                id: 'K06_pif_renegotiation', title: '', image: 'assets/event-kushner-exposure.png',
                description: '',
                minDay: 45, maxDay: 65,
                condition: () => SIM.uniqueResource > 60 && (SIM.storyFlags?.senate_subpoena_testified || SIM.storyFlags?.senate_subpoena_challenged || SIM.storyFlags?.senate_subpoena_leaked),
                choices: [
                    { text: '', effects: { credibility: 10, exposure: 20, domesticApproval: -5 },
                      flavor: '',
                      setFlags: { pif_disclosed: true } },
                    { text: '', effects: { tension: -5, diplomaticCapital: 10, exposure: 10 },
                      flavor: '',
                      setFlags: { pif_accelerated: true },
                      chainEvent: 'K07_the_recording', chainDelay: 8,
                      chainHint: 'The accelerated timeline is drawing attention...' },
                    { text: '', effects: { exposure: -15, diplomaticCapital: -5 },
                      flavor: '',
                      setFlags: { pif_renegotiated: true },
                      specialEffect: function() { SIM.dealValue = Math.max(0, (SIM.dealValue || 0) - 100); } },
                ],
            },
            {
                id: 'K07_the_recording', title: '', image: 'assets/event-kushner-exposure.png',
                description: '',
                minDay: 55, maxDay: 75,
                condition: () => SIM.uniqueResource > 70 && (SIM.storyFlags?.pif_disclosed || SIM.storyFlags?.pif_accelerated || SIM.storyFlags?.pif_renegotiated),
                choices: [
                    { text: '', effects: { domesticApproval: -10, exposure: 25, credibility: 8, internationalStanding: -5 },
                      flavor: '' },
                    { text: '', effects: { exposure: -10, diplomaticCapital: -10 },
                      flavor: '',
                      contactEffect: { id: 'mbs', trust: -15 },
                      specialEffect: function() { SIM.dealValue = (SIM.dealValue || 0) + 50; } },
                    { text: '', effects: { domesticApproval: -5, exposure: 15, credibility: 15 },
                      flavor: '' },
                ],
            },
        ],
