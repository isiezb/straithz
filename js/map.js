...
function renderMap() {
    ...
    // Static overlays only — no animated entities
    ctx.save();
    ctx.translate(mapX, 0);
...
// --- Entity drawing removed (sprites deleted) ---
function drawEntities(ctx, w, h) {
    // No-op: sprite-based entity animations removed
}
...
function drawPlatforms(ctx, w, h) {
    // No-op: sprite-based platform drawing removed
}
